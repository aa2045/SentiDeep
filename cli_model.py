...
from keras.layers import Dense, LSTM, Embedding, Dropout, Bidirectional, Flatten
...
class ModelTrain:
    ...
    def model_bilstm(self, num_word, embedding_dim, embedding_matrix, max_length):
        ...
        model.add(Bidirectional(LSTM(16, dropout=0.3, recurrent_dropout=0.1,
    ...
    def call_tokenize(self, model_name, embedding_dimensions, embed_model):
        ...
        Returns:
            Embedding matrix, padded samples, encoded labels, length of the
            vocabulary and the mean length of the
            samples
    ...
    def k_fold_train(self, model_name, embed_model, epochs_num):
        """Trains the model by employing stratified k-fold cross validation technique
        ...
        for i in report_list:
            ...
            # prints a classification report for all 5 folds together
        print("-------------------------------------------------------------------------------------------------------")
        print("                                 Report                            ")

        print(
            "---------------------------------------------------------------------------------------------------------")
        print("Fold        Overall           Neg  Neu  Pos              Neg  Neu  Pos                   Neg  Neu  Pos ")
        print("-------------------------------------------------------------------------------------------------------")
        print(
